...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-amr-036-0014-composite-periodic-entire-functions-fd9247c8-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/AMR-036-0014"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-amr-036-0014-composite-periodic-entire-functions-fd9247c8-v1",
      "problem_contract_sha256": "1371b45f0c386cccef44c00ebcd3e2b81cba7a254590e6cd3c82bc3217d4cd87",
      "problem_id": "problem:um-amr-036-0014-composite-periodic-entire-functions-fd9247c8",
      "route_id": "route:um-amr-036-0014-composite-periodic-entire-functions-fd9247c8-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-amr-036-0014-composite-periodic-entire-functions-fd9247c8-source-fidelity-01",
      "graph_id": "graph:um-amr-036-0014-composite-periodic-entire-functions-fd9247c8-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-amr-036-0014-composite-periodic-entire-functions-fd9247c8-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-amr-036-0014-composite-periodic-entire-functions-fd9247c8-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Classify entire functions $f,g$ for which $f\\circ g$ is periodic. Prove that, up to the natural equivalences, the possibilities are exhausted by: $g$ periodic; $g(z+T)=g(z)+K$ with $f$ $K$-periodic; $g$ quadratic; or $g=P\\circ h$ with $P$ quadratic, $h(z+T)=h(z)+K$, and $f\\circ P$ $K$-periodic."
          },
          "statement_sha256": "9bf12052cbd2dd5fee7348a40a21e6ea27442ed8a59598361fabc85bab60590f"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-amr-036-0014-composite-periodic-entire-functions-fd9247c8-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-amr-036-0014-composite-periodic-entire-functions-fd9247c8-root",
      "route_id": "route:um-amr-036-0014-composite-periodic-entire-functions-fd9247c8-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-036-0014-a0dd91ba5bca",
        "url": "https://www.unsolvedmath.com/problems/AMR-036-0014"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
